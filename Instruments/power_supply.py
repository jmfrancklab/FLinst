...
class PowerSupply(socket.socket):
    ...
    """
    def __init__(self, host, port=5025, timeout_ms=5, delay_s=0.1):
    ...
    def readandchop(self, bufsize=1024, timeout_ms=5, max_attempts=3):
        """
        ...
        :param timeout_ms: timeout in milliseconds for each recv (default 5)
...
# Example usage:
# with PowerSupply('192.168.1.50') as ps:
#     print(ps.remote())
#     print(ps.set_current(5.0))
#     print(ps.enable_output(True))
#     print('Measured current:', ps.measure_current())
