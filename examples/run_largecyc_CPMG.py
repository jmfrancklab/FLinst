...
# }}}
input(
    "I'm assuming that you've tuned your probe to %f since "
    "that's what's in your .ini file. Hit enter if this is true"
...
data.set_prop("postproc_type", "spincore_diffph_CPMG_v2")
data.set_units("t2", "s")
data.set_prop(
    "coherence_pathway",
    {
